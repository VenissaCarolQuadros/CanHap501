...
That being said, I still thoroughly enjoyed this lab, and although it took a fair bit of time, I now feel much more confident about working with the Haply. If you want to play Adventures of Ball-E yourself you can find the code here: [Ball-E Source Code](https://github.com/VenissaCarolQuadros/CanHap501/tree/main/labs/code/lab2/BallE). It is admittedly in need of a clean-up, so I hope using it as is is all you want to do.
