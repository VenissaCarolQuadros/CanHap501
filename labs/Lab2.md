...
### Reflections
I thoroughly enjoyed this lab, and although it took a fair bit of time (owing mainly to my own over-enthusiasm and bad decisions), I now think I feel much more confident about working with the Haply. If you want to play with Ball-E yourself you can find the code here: . It is admitedly in need of a clean up, so I hope using it as is is all you want to do.
